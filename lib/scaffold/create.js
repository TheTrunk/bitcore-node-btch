...
var BASE_PACKAGE = {
  description: 'A full btch node build with Bitcore',
  repository: 'https://github.com/TheTrunk/bitcore-node-btch',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-btch': 'TheTrunk/bitcore-lib-btch',
    'bitcore-node-btch': 'TheTrunk/bitcore-node-btch'
  }
};
